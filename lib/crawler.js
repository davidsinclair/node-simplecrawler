...
var Crawler = function(host,initialPath,initialPort,interval) {
	...
	// Should we filter by referrerDomain?  This is useful for checking links 
	// on a website where you want to check all links from a given domain
...
Crawler.prototype.queueURL = function(url,queueItem) {
	...
	var internalReferrer = queueItem.host === crawler.host;

	if (fetchDenied || (crawler.filterByReferrerDomain && !internalReferrer) ) {
